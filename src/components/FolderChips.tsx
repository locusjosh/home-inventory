...
type Props = {
  selected: string | "all" | "low";
  counts: Record<string, number>;
  lowCount: number;
  onSelect: (folder: string | "all" | "low") => void;
};

export function FolderChips({ selected, counts, lowCount, onSelect }: Props) {
  const chips: { key: string | "all" | "low"; label: string; count: number }[] = [
